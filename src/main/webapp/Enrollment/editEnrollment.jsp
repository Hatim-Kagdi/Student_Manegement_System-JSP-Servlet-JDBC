...
<body>
	...
	<form action="<%=request.getContextPath()%>/updateEnrollment"
		method="post">
		<input type="hidden" name="enrollmentId"
			value="<%=enrollment.getEnrollmentId()%>"><br>
		<br> Student Name : <select name="studentId" required>
		...
		<br> Course Name : <select name="courseId" required>
	...
	<br>
	<br>
	<a href="viewEnrollments"><button>Back</button></a>
